...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Repository root containing data/raw/d7_active_giant_2016_01/.",
    )
    args = parser.parse_args()

    repo_root = args.repo_root
    source_dir = repo_root / "data" / "raw" / "d7_active_giant_2016_01"
    out_dir = repo_root / "data" / "train_ready" / "d7_active_giant_2016_01"
    ...
    write_json(
        ...
        {
            "dataset": "d7_active_giant_2016_01",
            "source": "data/raw/d7_active_giant_2016_01",
            "output": "data/train_ready/d7_active_giant_2016_01",
            "graph": graph_summary,
