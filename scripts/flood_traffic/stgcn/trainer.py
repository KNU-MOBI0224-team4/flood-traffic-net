...
from flood_traffic.stgcn.losses import MaskedBCEWithLogitsLoss
    ...
    *,
    ...
    for epoch in range(epochs):
        ...
        train_loss = _train_one_epoch(
            model, train_loader, optimizer, criterion, A_hat_t, device_obj, grad_clip
        )
        val_scores, val_targets, val_masks = _infer_loader(model, val_loader, A_hat_t, device_obj)
...
def predict_score_matrix(
    ...
    scores, _t, _m = _infer_loader(model.to(device_obj), loader, A_hat_t, device_obj)
